            ...
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    <a href="images/menu-2.jpg" class="image-popup"><img
                            src="{{ asset('storage/' . $data->product_image1) }}" class="img-fluid"
                    ...
                    <form action="{{ route('cart') }}" method="POST">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="input-group col-md-6 d-flex mb-3">
                                ...
                                <input type="text" id="quantity" name="cart_quantity" class="form-control input-number"
                        ...
                        <button class="btn btn-black py-3 px-5" type="submit">Add to Cart</button>
